...
#  >>> import function_exercises as funct
...
print(list(permutations('abc''123', 6)))


print(len(list(permutations('abc''123', 6))))
...
# 3. (Bonus) Save this file as profiles.json inside of your exercises directory (right click -> save file as...).
